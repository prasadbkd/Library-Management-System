...
componentDidMount(){
    ...
    fetch("http://localhost:3000/librarians").then(result=>result.json().then(data=>this.setState({
        librarian:data
    })))
    .catch((error)=>console.log(error));
}
               ...
               <div className="container login-container">
                    <div className="row">
                        ...
                        <div className="form-group">
                            <input type="text" className="form-control" placeholder="Your Email *"  name='email' onChange={this.change}/>
                        </div>
                        <div className="form-group">
                            <input type="password" className="form-control" placeholder="Your Password *"  name='password' onChange={this.change}/>
                        </div>
                        <div className="form-group">
